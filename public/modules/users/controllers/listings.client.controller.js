...
angular.module('users').controller('ListingsController', ['$scope','$stateParams', '$location', 'Authentication', 'UsersList',
	function($scope,$stateParams, $location, Authentication, UsersList) {
